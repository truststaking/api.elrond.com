...
export class NodeController {
  ...
  async getNodes(
    ...
    @Query('type', new ParseOptionalEnumPipe(NodeType))
    type: NodeType | undefined,
    @Query('status', new ParseOptionalEnumPipe(NodeStatus))
    ...
    @Query('sort', new ParseOptionalEnumPipe(NodeSort))
    sort: NodeSort | undefined,
    @Query('order', new ParseOptionalEnumPipe(SortOrder))
