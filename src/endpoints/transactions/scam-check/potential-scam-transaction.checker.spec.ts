...
describe('PotentialScamTransactionChecker', () => {
  ...
  it('empty data - returns false', async () => {
    ...
    input.data = '';
    input.sender =
      'erd15ws5qefhx49n666qtksumyr4tcy6ynzzga8frq4zfazexd3xng0s4explm';
    input.receiver =
      'erd1k7j6ewjsla4zsgv8v6f6fe3dvrkgv3d0d9jerczw45hzedhyed8sh2u34u';
  ...
  it('data more than min, receiver is SC - returns false', async () => {
    ...
    input.sender =
      'erd1k7j6ewjsla4zsgv8v6f6fe3dvrkgv3d0d9jerczw45hzedhyed8sh2u34u';
    input.receiver =
      'erd1qqqqqqqqqqqqqpgqy20dhf2t8dgpfuewhzncjl8vmsw59evv0n4sd3ntck';
